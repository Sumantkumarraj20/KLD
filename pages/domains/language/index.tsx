...
export default function LanguageDomainPage() {
  ...
  return (
    <>
      <Head>
        <title>Language Learning - Kids Points</title>
        <meta name="description" content="Practice Language Skills" />
      </Head>
        ...
        <div className="max-w-6xl mx-auto px-4 py-8">
          ...
          <div className="mb-8">
            ...
            <div className="bg-white rounded-xl shadow-lg p-6">
              ...
              <p className="text-neutral-600">
                Practice writing, reading, and listening skills
              </p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {Array.from({ length: 50 }, (_, i) => i + 1).map((level) => (
              <LanguageLevelCard key={level} kidId={kid.kid_id} levelNumber={level} />
            ))}
          </div>
        </div>
      </div>
...
function LanguageLevelCard({
  ...
  useEffect(() => {
    ...
    const lockStatus = gameAPI.getLevelLockStatus(kidId, "language", levelNumber);
    const prevCompletion = gameAPI.getLevelCompletion(
      kidId,
      "language",
      levelNumber - 1
    );
    const levelCompletion = gameAPI.getLevelCompletion(kidId, "language", levelNumber);
  ...
  return (
    ...
    >
      ...
      {/* Level Number */}
      <div className="text-3xl font-bold text-blue-600 mb-2">Level {levelNumber}</div>
